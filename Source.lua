    ...
    Themes = {
        Sonic = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 102, 204)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 153, 255)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 102, 204))
            }),
            ["Color Hub 2"] = Color3.fromRGB(0, 102, 204),
            ["Color Stroke"] = Color3.fromRGB(0, 77, 153),
            ["Color Theme"] = Color3.fromRGB(0, 153, 255),
