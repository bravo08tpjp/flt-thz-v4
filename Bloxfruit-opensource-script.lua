                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script Nebula System Hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Window = Fluent:CreateWindow({
    Title = " Nebula System Hub | Blox Fruits",
    SubTitle = "Version 2",
    TabWidth = 160,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://119363150271347" }),
...
setclipboard("Nebula System Hub Is The Best")
...
ImageButton.Image = "http://www.roblox.com/asset/?id=119363150271347"
...
Tabs.Main:AddButton({
        Title = "Nebula System Hub Discord Server",
...
Fluent:Notify({
    Title = "Nebula System Hub",
    Content = "Thanks For Using Nebula System Hub",
    Duration = 8
})
